...
class S3Hook(AwsBaseHook):
    ...
    def list_all_keys(
        ...
        """
        Lists all keys in folders and its sub folders in a bucket under prefix containing delimiter
        ...
        **Example**: Returns the list of S3 object with LastModified attr greater than from_datetime
        ...
        if self.object_filter_usr is not None:
            return self.object_filter_usr(objects, from_datetime, to_datetime)

        return self._list_key_object_filter(objects, from_datetime, to_datetime)
